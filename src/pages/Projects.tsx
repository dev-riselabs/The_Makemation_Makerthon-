          ...
          <div key={index} className="border border-border-card rounded-2xl p-6 bg-bg-primary">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="flex items-center gap-2 bg-bg-primary border border-border-card text-text-primary text-sm font-bold px-5 py-2.5 rounded-lg hover:border-brand transition-colors">
