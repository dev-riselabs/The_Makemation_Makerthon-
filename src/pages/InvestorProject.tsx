      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <input type="text" placeholder="Search projects..." className="pl-9 pr-4 py-2 border border-border-secondary rounded-lg text-sm font-medium focus:outline-none focus:border-brand w-60 md:w-75" />
          </div>
          <button 
