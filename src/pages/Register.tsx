      ...
      {isInvestor ? (
        <div className="flex items-center md:justify-center justify-start w-full max-w-2xl mx-auto mb-12 overflow-x-auto py-4 px-4 snap-x">
          ...
          <div className="flex items-center shrink-0">
            <div className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-quicksand text-sm transition-colors ${step === 1 ? 'bg-brand text-text-primary font-bold shadow-md' : 'bg-bg-tertiary text-text-tertiary font-medium'}`}>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
              Account
            </div>
            <div className="h-0.5 w-6 md:w-12 bg-border-secondary"></div>
          </div>

          {/* Step 2 */}
          <div className="flex items-center shrink-0">
            <div className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-quicksand text-sm transition-colors ${step === 2 ? 'bg-brand text-text-primary font-bold shadow-md' : 'bg-bg-tertiary text-text-tertiary font-medium'}`}>
          ...
          {/* Step 3 */}
          <div className="flex items-center shrink-0">
            <div className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-quicksand text-sm transition-colors ${step === 3 ? 'bg-brand text-text-primary font-bold shadow-md' : 'bg-bg-tertiary text-text-tertiary font-medium'}`}>
        ...
        <div className="flex items-center md:justify-center justify-start w-full max-w-2xl mx-auto mb-12 overflow-x-auto py-4 px-4 snap-x">
          ...
          {/* Step 4 */}
          <div className="flex items-center shrink-0">
            <div className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-quicksand text-sm transition-colors ${step === 4 ? 'bg-brand text-text-primary font-bold shadow-md' : 'bg-bg-tertiary text-text-tertiary font-medium'}`}>
        ...
        <form className="w-full flex flex-col font-quicksand">
            ...
            <>
              ...
              <div className="grid md:grid-cols-2 gap-x-6 gap-y-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" placeholder="John" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>
                
                {/* Last Name */}
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-text-secondary">Last Name *</label>
                  <input type="text" placeholder="Doe" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <input type="email" placeholder="me@gmail.com" className="w-full px-4 py-3 pr-10 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                    <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-icon-gray">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input type="tel" placeholder="080 000 0000" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <input type="password" placeholder="Min 8 chars" className="w-full px-4 py-3 pr-10 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                    <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-icon-gray">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                    </button>
                  </div>
                  <p className="text-[11px] text-icon-gray mt-1">Password: 8+ chars, uppercase, lowercase, number, special char</p>
                </div>

                {/* Confirm Password */}
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-text-secondary">Confirm *</label>
                  <input type="password" placeholder="Confirm" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>
              </div>
            ...
            <>
              ...
              <div className="grid md:grid-cols-2 gap-x-6 gap-y-6">
                ...
                <div className="flex flex-col gap-2 md:col-span-2">
                  ...
                  <input type="text" placeholder="Your project name" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>

                {/* University */}
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-text-secondary">University *</label>
                  <input type="text" placeholder="University name" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>

                {/* Location */}
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-text-secondary">Location *</label>
                  <input type="text" placeholder="Lagos, Nigeria" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>
                ...
                <div className="flex flex-col gap-2 md:col-span-2">
                  ...
                  <div className="relative">
                    <input type="text" placeholder="Min 8 chars" className="w-full px-4 py-3 pr-10 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                    <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-icon-gray">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                    </button>
                  </div>
              ...
              <div className="flex justify-between items-center mt-10">
                <button onClick={() => setStep(1)} type="button" className="flex items-center gap-2 font-bold font-jost text-text-primary hover:text-text-secondary transition-colors">
            ...
            <>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" placeholder="Your firm name" className="w-full px-4 py-3 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                </div>
                    ...
                    {['Angel Investor', 'Venture Capital', 'Private Equity', 'Family Office', 'Corporate VC', 'Development Finance'].map((item, idx) => {
                      ...
                      return (
                        <button 
                          ...
                          className={`w-full px-4 py-4 rounded-xl border text-sm font-medium transition-colors text-center ${isSelected ? 'bg-text-primary text-bg-primary border-text-primary' : 'bg-bg-primary border-border-secondary text-text-secondary hover:border-text-primary hover:text-text-primary'}`}
                        >
                          {item}
                        </button>
                      );
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <input type="text" placeholder="Search and select sectors..." className="w-full px-4 py-3 pr-10 rounded-xl border border-border-secondary focus:outline-none focus:border-brand text-text-primary placeholder-icon-gray bg-bg-secondary" />
                    <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-icon-gray">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                    </button>
                  </div>
                  <p className="text-[10px] text-icon-gray mt-1">Select all sectors that match your investment focus</p>
                </div>
              </div>
          ...
          {step === 3 && !isInvestor && (
            <>
                    ...
                    {['Concept', 'Feasibility Completed', 'Seeking Financing', 'Construction/Development', 'Operational/Expansion'].map((item, idx) => {
                      ...
                      return (
                        <button 
                          ...
                          className={`w-full px-4 py-3 rounded-xl border text-sm font-medium transition-colors text-center ${isSelected ? 'bg-text-primary text-bg-primary border-text-primary' : 'bg-bg-primary border-border-secondary text-text-secondary hover:border-text-primary hover:text-text-primary'}`}
                        >
                          {item}
                        </button>
                      );
              ...
              <div className="flex justify-between items-center mt-10">
                <button onClick={() => setStep(2)} type="button" className="flex items-center gap-2 font-bold font-jost text-text-primary hover:text-text-secondary transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>
                  Back
                </button>
            ...
            <>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="w-full border border-dashed border-border-dark rounded-xl p-8 flex flex-col items-center justify-center bg-bg-secondary/50 cursor-pointer hover:bg-bg-secondary transition-colors">
                    ...
                    <p className="text-[10px] text-text-tertiary font-medium tracking-wide">PDF, PNG, DOC, DOCX [MAX. 5MB]</p>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-center mt-12">
                <button onClick={() => setStep(3)} type="button" className="flex items-center gap-2 font-bold font-jost text-text-primary hover:text-text-secondary transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>
                  Back
                </button>
                <button type="submit" onClick={(e) => e.preventDefault()} className="bg-brand text-text-primary font-bold font-jost px-8 py-3 rounded-xl flex items-center gap-2 hover:opacity-90 transition-opacity">
