...
const navItemsOwner = [
  {name : 'My Project', path : '/owner/overview', icon : GoProject},
  {name : 'Uploads', path : '/owner/upload', icon : LuUpload},
  {name : 'Message', path : '/owner/message', icon : HiOutlineEnvelope},
  {name : 'FAQs', path : '/owner/faq', icon : LuMessageCircleQuestion},
]

let arrLinks =  isAdmin ? navItemsAdmin : navItemsOwner
